...
<header class="bg-Apple h-16 flex justify-end items-center">
    <div class="p-2.5 mt-3 flex items-center rounded-md px-4 duration-300 cursor-pointer hover:bg-Forestgreen text-white">
        ...
        <a href="{{ route('Home') }}" class="text-[15px] ml-2 text-gray-200 font-bold">Contact</a>
    </div>
</header>
...
<div class="sidebar fixed top-0 bottom-0 lg:left-0 p-2 w-[300px] overflow-y-auto text-center bg-Apple">
    ...
    <div class="p-2.5 mt-3 flex items-center rounded-md px-4 duration-300 cursor-pointer hover:bg-Forestgreen text-white">
        ...
        <a href="{{ route('Home') }}" class="text-[15px] ml-4 text-gray-200 font-bold">Home</a>
    </div>
    <div class="p-2.5 mt-3 flex items-center rounded-md px-4 duration-300 cursor-pointer hover:bg-Forestgreen text-white">
        <i class="bi bi-house-door-fill"></i>
        <i class='bx bx-question-mark' ></i>
        <a href="{{ route('Questionnaire') }}" class="text-[15px] ml-4 text-gray-200 font-bold">Questionnaire</a>
    </div>
    <div
    ...
    >
        ...
        <a href="{{ route('Gesprek-inplannen') }}" class="text-[15px] ml-4 text-gray-200 font-bold">Gesprek inplannen</a>
    </div>
    ...
    >
        ...
        <a href="{{ route('Home') }}" class="text-[15px] ml-4 hover:bg-Forestgreen font-bold" >Account</a>
    </div>
